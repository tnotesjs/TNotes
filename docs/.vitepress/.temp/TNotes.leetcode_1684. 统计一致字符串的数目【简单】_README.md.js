...
const __pageData = JSON.parse('{"title":"1684. 统计一致字符串的数目【简单】","description":"","frontmatter":{},"headers":[],"relativePath":"TNotes.leetcode/1684. 统计一致字符串的数目【简单】/README.md","filePath":"TNotes.leetcode/1684. 统计一致字符串的数目【简单】/README.md"}');
const _sfc_main = { name: "TNotes.leetcode/1684. 统计一致字符串的数目【简单】/README.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("TNotes.leetcode/1684. 统计一致字符串的数目【简单】/README.md");
