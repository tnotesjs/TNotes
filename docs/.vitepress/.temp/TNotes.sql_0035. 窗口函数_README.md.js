...
const __pageData = JSON.parse('{"title":"0035. 窗口函数","description":"","frontmatter":{},"headers":[],"relativePath":"TNotes.sql/0035. 窗口函数/README.md","filePath":"TNotes.sql/0035. 窗口函数/README.md"}');
const _sfc_main = { name: "TNotes.sql/0035. 窗口函数/README.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="0035-窗口函数" tabindex="-1"><a href="https://github.com/Tdahuyou/TNotes.mysql/tree/main/notes/0035.%20%E7%AA%97%E5%8F%A3%E5%87%BD%E6%95%B0" target="_self" rel="noopener">0035. 窗口函数</a> <a class="header-anchor" href="#0035-窗口函数" aria-label="Permalink to &quot;[0035. 窗口函数](https://github.com/Tdahuyou/TNotes.mysql/tree/main/notes/0035.%20%E7%AA%97%E5%8F%A3%E5%87%BD%E6%95%B0)&quot;" target="_self" rel="noopener">​</a></h1><ul><li><a href="#1--%E6%A6%82%E8%BF%B0" target="_self" rel="noopener">1. 📝 概述</a></li></ul><h2 id="1--概述" tabindex="-1">1. 📝 概述 <a class="header-anchor" href="#1--概述" aria-label="Permalink to &quot;1. 📝 概述&quot;" target="_self" rel="noopener">​</a></h2><p>窗口函数</p><ul><li>在 MySQL 8.0 版本中，新增了一个窗口函数，用它可以实现很多新的查询方式。窗口函数类似于 SUM()、COUNT()那样的集合函数，但它并不会将多行查询结果合并为一行，而是将结果放回多行当中。</li></ul><p>窗口函数（Window Functions）</p><ul><li>类似聚合函数，但不合并多行为一行</li><li>示例函数： <ul><li><code>ROW_NUMBER()</code>, <code>RANK()</code>, <code>DENSE_RANK()</code></li><li><code>SUM(...) OVER (...)</code>, <code>AVG(...) OVER (...)</code></li></ul></li></ul><div class="language-sql vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sql</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="${ssrRenderStyle({ "--shiki-light": "#D73A49", "--shiki-dark": "#F97583" })}">SELECT</span><span style="${ssrRenderStyle({ "--shiki-light": "#D73A49", "--shiki-dark": "#F97583" })}"> name</span><span style="${ssrRenderStyle({ "--shiki-light": "#24292E", "--shiki-dark": "#E1E4E8" })}">, salary,</span></span>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("TNotes.sql/0035. 窗口函数/README.md");
