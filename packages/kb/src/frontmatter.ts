 ...
 */
export function serializeNoteContent(frontmatter: NoteFrontmatter, body: string): string {
...
export function updateNoteFrontmatter(content: string, updates: Partial<NoteFrontmatter>): string {
