/**
 * 移植自 `@milkdown/crepe@7.22.1` 的 `lib/esm/feature/link-tooltip`（MIT）。
 *
 * 改动：去掉 Crepe 的 `FeaturesCtx`/`CrepeCtx`；图标/文案默认值原样保留。
 */
import type { Editor } from '@milkdown/kit/core'
import type { LinkTooltipConfig } from '@milkdown/kit/component/link-tooltip'
import {
...
export function linkTooltip(editor: Editor, config: Partial<LinkTooltipConfig> = {}): void {
  editor
    ...
    .config((ctx) => {
      ctx.update(linkTooltipConfig.key, (prev) => {
        ...
        return {
          ...
          removeButton:
            (_c = config == null ? void 0 : config.removeButton) != null ? _c : removeIcon,
          confirmButton:
            (_d = config == null ? void 0 : config.confirmButton) != null ? _d : confirmIcon,
          inputPlaceholder:
            (_e = config == null ? void 0 : config.inputPlaceholder) != null ? _e : 'Paste link...',
