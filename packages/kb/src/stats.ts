...
import { isGitRepository, listCommitsOldestFirst, listRootCommits, readFileAtCommit } from './git'
 ...
 */
export async function computeCompletedNotesCount(rootPath: string): Promise<StatsUpdateResult> {
