 ...
 */
const EN_WORDS_REPO_BASE_URL = 'https://github.com/Tdahuyou/en-words/blob/main/'

/**
 * 超链接 a 标签的 target 属性值
 */
const TARGET = '_blank'
    ...
    <div class="__EnWordList__">
        ...
        <ol>
            <li v-for="word in sortedWords" :key="word">
                ...
                <label :for="word">
                    <a :href="generateLink(word)" :target="TARGET" :class="{ 'line-through': checkedStates[word] }">
                        {{ word }}
                    </a>
                </label>
            </li>
