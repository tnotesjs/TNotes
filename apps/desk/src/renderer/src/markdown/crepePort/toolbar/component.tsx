...
export const Toolbar = defineComponent<ToolbarProps>({
  props: {
    features: {
      type: Object as PropType<DeskToolbarFeatures>,
      default: () => DEFAULT_DESK_TOOLBAR_FEATURES,
    },
    ctx: {
      type: Object,
      required: true,
  ...
  setup(props) {
    ...
    getGroups(config, ctx, props.features ?? DEFAULT_DESK_TOOLBAR_FEATURES)
  )
