...
const __pageData = JSON.parse('{"title":"React + Vite","description":"","frontmatter":{},"headers":[],"relativePath":"TNotes.react/0009. 在 JSX 中使用 JS 表达式/demos/2/README.md","filePath":"TNotes.react/0009. 在 JSX 中使用 JS 表达式/demos/2/README.md"}');
const _sfc_main = { name: "TNotes.react/0009. 在 JSX 中使用 JS 表达式/demos/2/README.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("TNotes.react/0009. 在 JSX 中使用 JS 表达式/demos/2/README.md");
