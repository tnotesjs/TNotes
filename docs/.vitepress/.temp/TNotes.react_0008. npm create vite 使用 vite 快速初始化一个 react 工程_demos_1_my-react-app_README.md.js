...
const __pageData = JSON.parse('{"title":"React + Vite","description":"","frontmatter":{},"headers":[],"relativePath":"TNotes.react/0008. npm create vite 使用 vite 快速初始化一个 react 工程/demos/1/my-react-app/README.md","filePath":"TNotes.react/0008. npm create vite 使用 vite 快速初始化一个 react 工程/demos/1/my-react-app/README.md"}');
const _sfc_main = { name: "TNotes.react/0008. npm create vite 使用 vite 快速初始化一个 react 工程/demos/1/my-react-app/README.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("TNotes.react/0008. npm create vite 使用 vite 快速初始化一个 react 工程/demos/1/my-react-app/README.md");
