...
const notes = [{ index: '0001', id: '10000000-0000-4000-8000-000000000001' }, { index: '0002' }]
...
describe('note URL aliases', () => {
  ...
  it('resolves paths under a site base', () => {
    expect(resolveNotePath('/fixture/notes/0001.%20%E6%AC%A2%E8%BF%8E', notes, '/fixture/')).toBe(
      '/notes/1'
    )
    expect(resolveNotePath('/fixture/notes/1', notes, '/fixture/')).toBe('/notes/1')
  })
